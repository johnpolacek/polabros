  ...
  return (
    <main className="relative fade-in-2 animation-delay-2">
      ...
      <div className="flex items-center flex-col relative z-20">
        <h2
          className="fade-in-2 animation-delay-3 py-16 text-white max-w-[360px] text-center text-xl"
          style={{
        ...
        <h1
          className="fade-in-4 animation-delay-3 text-8xl font-bold text-white"
          style={{
